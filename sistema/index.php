...
$sql = mysqli_query($conexion, "SELECT count(*) FROM valuacion where estatus ='Entregado'");
...
}$sql1 = mysqli_query($conexion, "SELECT count(*) FROM valuacion where estatus ='Espera Autorizacion'");
...
$sql2 = mysqli_query($conexion, "SELECT count(*) FROM valuacion where estatus ='Proceso'");
...
<div class="container-fluid">
	...
	<div class="row">
		...
		<!-- Earnings (Monthly) Card Example -->
		<a class="col-xl-3 col-md-6 mb-4" href="lista_autorizadas.php">
			<div class="card border-left-warning shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Unidades Espera Autrización</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $esper ?></div>
						</div>
						<div class="col-auto">
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_proceso.php">
			<div class="card border-left-info shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Unidades Proceso</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $proces ?></div>
						</div>
						<div class="col-auto">
							<i class="fas fa-users fa-2x text-gray-300"></i>
						</div>
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_entregadas.php">
			<div class="card border-left-success shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1">Unidades Entregadas</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $entreg ?></div>
						</div>
						<div class="col-auto">
							<i class="fas fa-users fa-2x text-gray-300"></i>
						</div>
