  ...
  <div class="row">
    <div class="col-lg-6 m-auto">
      ...
      <div class="form-group">
        <label for="os1">Orden de Servicio</label>
        <input type="text" class="form-control" name="os1" id="os1" value="<?php echo $orden_OS; ?>" disabled>
      </div>
      <div class="form-group">
...
//echo '<img width="100" src="data:image/jpeg;base64,'.base64_encode( $data3['imagen'] ).'"/> ';
      ...
      <div id="div_compl" style="display: none;">
        <form action="accion_compl.php" method="post" name="form_new_os" id="form_new_os" enctype="multipart/form-data">
          <div class="form-group">
            <label for="os_c">Orden de Servicio</label>
            <input type="text" class="form-control" name="os_c" id="os_c" value="<?php echo $orden_OS; ?>" readonly>
          </div>
          <div class="form-group">
            <label for="image[]">Fotos(Complementos)</label><br>
            <input type="file" class="btn btn-primary " name="imagen[]" id="imagen[]" multiple accept="image/*">
          </div>
          <div class="form-group">
