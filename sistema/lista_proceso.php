...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de Unidades en Proceso</h1>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT ru.orden_servicio, ru.seguro_particular, v.fecha_promesa, v.fecha_termino, v.tipo_valuacion FROM registro_unidad ru INNER JOIN valuacion v ON ru.orden_servicio = v.orden_servicio where v.estatus = 'Proceso'");
