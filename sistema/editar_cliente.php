...
if (!empty($_POST)) {
  ...
  if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
    ...
    if ($resul >= 1) {
      ...
      $sql_update = mysqli_query($conexion, "UPDATE cliente SET dni = $dni, nombre = '$nombre' , telefono = '$telefono', direccion = '$direccion', seg_par = '$seg_par' WHERE idcliente = $idcliente");
          ...
          <div class="row">
            <div class="col-lg-6 m-auto">
              ...
              <form class="" action="" method="post">
                ...
                <div class="form-group">
                  <label for="seg_par">Seguro/Particular</label>
                  <input type="text" placeholder="Ingrese Seguro/Particular" name="seg_par" class="form-control" id="seg_par" value="<?php echo $seg_par; ?>">
                </div>
