...
$link = mysqli_connect("localhost",	"root", "", "sisptr");
...
$sql = "INSERT INTO chats (uname, msg, dt,$estado) VALUES ('$un', '$m', '$ts', 1)";
	...
	<style>
		*{
		...
		main footer .input2{
			...
			color:black;
			text-align:center;
			background-color:#A0A9BB;
			border: 2px solid #A0A9BB; 
		}
	}
...
<body onload="show_func()">
	<div id="container">
		<main>
			...
			<form id="myform" action="groupchats.php" method="POST" >
		...
		<footer>
			<table>
				<tr>
					<th>
						<textarea id="msg" name="msg" rows='3' cols='50' autofocus>
						</textarea>
					</th>
					<th>
						<input class="input2" type="submit"	id="submit" name="submit" value="ENVIAR">
					</th>               
				</tr>
			</table>               
		</footer>
