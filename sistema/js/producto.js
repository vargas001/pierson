...
$('.btn_new_cliente').click(function(e) {
  ...
  $('#seg-part').removeAttr('disabled');

  $('#div_registro_cliente').slideDown();

});

// activar Areas Dañadas
$('.btn_new_os').click(function(e) {
  e.preventDefault();
  
  $('#div_registro_areas').slideDown();
  $('#div_registro_areas2').slideDown();
  $('#div_registro_areas3').slideDown();
  $('#div_registro_areas4').slideDown();

});

//activar complementos
$('.btn_compl').click(function(e) {
  e.preventDefault();
  $('#div_compl').slideDown();
});

//activar ver complementos
$('.btn_vercompl').click(function(e) {
  e.preventDefault();
  $('#div_vercompl').slideDown();
});
